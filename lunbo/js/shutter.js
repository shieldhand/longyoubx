  ...
  Shutter.prototype = {
    ...
    gridWhole: function (index, showNum) {
      ...
      if (showNum === 0) {
        ...
        $createElem.velocity({left: movingVal}, {duration: 699});
      } else if (showNum === 1) {
        movingVal = -this.shutterW;
        ...
        $createElem.velocity({top: movingVal}, {duration: 699});
      } else if (showNum === 3) {
        movingVal = -this.shutterH;
    ...
    gridTop: function (index, showNum) {
      ...
      if (showNum === 0) {
        ...
        $curElem.find('.created').each(function (i) {
          ...
          $(this).velocity({top: movingVal}, {duration: 699});
        });
      } else if (showNum === 1) {
        $curElem.find('.created').each(function (i) {
          speed = 80 * i;
      ...
      this.recovery($targetElem, $curElem, index, backup, 699);
    },
    ...
    gridLeft: function (index, showNum) {
      ...
      if (showNum === 0) {
        ...
        $curElem.find('.created').each(function (i) {
          ...
          $(this).velocity({left: movingVal}, {duration: 699});
        });
      } else if (showNum === 1) {
        $curElem.find('.created').each(function (i) {
          speed = 80 * i;
    ...
    gridOpacity: function (index) {
      ...
      $createElem.velocity({opacity: 0}, {duration: 699});
